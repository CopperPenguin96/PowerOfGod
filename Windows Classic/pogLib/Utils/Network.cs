...
namespace pogLib.Utils
{
    ...
    public class Network
    {
        ...
        {
            string jsonResponse = Network.GetUrlSource("http://godispower.us/Application/live_status.json");
            LiveStatus status = JsonConvert.DeserializeObject<LiveStatus>(jsonResponse);
            return status.live;
        }
        ...
        public static string GetPageTitle(string url)
        {
            ...
            {
                Logging.LogLine(e.ToString(), LogLevel.Warning);
                return "Error";
            }
        }
        ...
        public static List<string> GetUrlSourceAsList(string urlF)
        {
            ...
            using (var client = new WebClient())
            {
                ...
                {
                    Logging.LogLine(e.ToString(), LogLevel.Error);
                }
