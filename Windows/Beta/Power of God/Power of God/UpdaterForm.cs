...
namespace Power_of_God
{
    public partial class UpdaterForm : Form
    {
        ...
        private static IEnumerable<string> Versions()
        {
            ...
            return Network.GetUrlSourceAsList(textFile);
        }
        ...
        {
            if (comboBox1.SelectedText != AppVersion.LatestOnline())
            {
        ...
        private void Download()
        {
            ...
            var dl = "http://godispower.us/Application/Download/" + phase + "/" + verCode + "/" + fullVersion.Replace(" ", "%20") + ".zip";
        ...
        {
            System.Diagnostics.Process.Start(FileSystem.MainDirectory + "/Updater.exe");
            Application.Exit();
        }
