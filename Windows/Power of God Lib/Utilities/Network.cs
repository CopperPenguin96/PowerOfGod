    ...
    public class Network
    {
        ...
        public static void DownloadScripture()
        {
            var dlForm = new DownloadDialogBox("Downloading Scripture",
                "Most features of Power of God require that you have the Scriptures downloaded. This is the inspired KJV version",
                "http://powerofgodonline.net/Application/kjv.xml", "power.of.god/Bibles/KJV.xml");
            dlForm.ShowDialog();
        }
