	...
	public PlanNotification() {
			try {
				NotificationCompat.Builder mBuilder =
					...
					.setContentTitle("Weekly Joke " + AppContext.mainActivityContext.getResources().getString(R.string.ver))
					.setContentText("Weekly Joke #is ready!");
				...
				android.support.v4.app.TaskStackBuilder stackBuilder = 
					android.support.v4.app.TaskStackBuilder.create(AppContext.mainActivityContext);
