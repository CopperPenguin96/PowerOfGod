...
public class ProgressBarMsgBox extends MsgBox {
    ...
    String url;
    public ProgressBarMsgBox(String title,
                             String message,
                             Context c,
                             String url,
                             ...
                             int ProgressStyle)
    {
        super(title, message + "\n\nDo not exit this dialog.", c);
        mProgressDialog = new ProgressDialog(c);
        mProgressDialog.setTitle(title);
        mProgressDialog.setMessage(message);
        this.url = url;
        mProgressDialog.setIndeterminate(ShowProgress);
        mProgressDialog.setProgressStyle(ProgressStyle);
        mProgressDialog.setCancelable(CanCancel);
        downloadTask = new DownloadTask(c, downloadLocation);
